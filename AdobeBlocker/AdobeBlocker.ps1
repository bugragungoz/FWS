...
<#
.SYNOPSIS
    Adobe Internet Access Blocker - Comprehensive Network Blocking Tool
    
.DESCRIPTION
    Advanced PowerShell script to block internet access for all Adobe applications
    and services through Windows Firewall rules, hosts file modifications, and IP blocking.
    
.NOTES
    Name:           Adobe Internet Access Blocker
    Author:         Bugra
...
$script:Config = @{
    LogDirectory     = "$PSScriptRoot\AdobeBlocker_Logs"
    BackupDirectory  = "$PSScriptRoot\AdobeBlocker_Backups"
    LogFile          = ""
    BackupFile       = ""
    ReportFile       = ""
    SessionID        = (Get-Date -Format "yyyyMMdd_HHmmss")
    DryRun           = $false
    RulePrefix       = "AdobeBlocker"
    RuleGroup        = "AdobeBlocker"
}
...
function Show-Banner {
    ...
    Write-Host "     ######  ##     ##  #######  ##     ## ########" -ForegroundColor Cyan
    Write-Host "                                                                                " -ForegroundColor Cyan
    Write-Host "           Adobe Internet Access Blocker v1.0.0                                 " -ForegroundColor Cyan
    Write-Host "                                                                                " -ForegroundColor Cyan
    Write-Host "================================================================================" -ForegroundColor Cyan
    Write-Host ""
...
function Initialize-Environment {
    try {
        ...
        $script:Config.LogFile = Join-Path $script:Config.LogDirectory "AdobeBlocker_$($script:Config.SessionID).log"
        $script:Config.BackupFile = Join-Path $script:Config.BackupDirectory "FirewallRules_$($script:Config.SessionID).json"
        $script:Config.ReportFile = Join-Path $script:Config.LogDirectory "AdobeBlocker_Report_$($script:Config.SessionID).txt"
...
function Show-BlockModeDisclaimer {
    ...
    Write-Host "     - Block all Adobe .exe files" -ForegroundColor White
    ...
    Write-Host "     - Add 40+ Adobe domain entries pointing to 0.0.0.0" -ForegroundColor White
    ...
    Write-Host "     - 130.248.0.0/16 (Adobe Systems - ~65,536 IPs)" -ForegroundColor White
    Write-Host "     - 192.150.0.0/16 (Adobe Systems - ~65,536 IPs)" -ForegroundColor White
    Write-Host "     - 193.104.215.0/24 (Adobe Systems EU - ~256 IPs)" -ForegroundColor White
    Write-Host ""
    ...
    Write-Host "  - Blocking may violate Adobe's Terms of Service" -ForegroundColor Yellow
    Write-Host ""
    Write-Host "================================================================================" -ForegroundColor Yellow
    Write-Host ""
}
...
function Show-DryRunDisclaimer {
    ...
    Write-Host "  - Scan all Adobe directories and files" -ForegroundColor White
    Write-Host "  - Detect Adobe services on your system" -ForegroundColor White
    ...
    Write-Host "  - Verify Adobe installation paths" -ForegroundColor White
...
function Show-UnblockDisclaimer {
    ...
    Write-Host "  - Restore Adobe's internet access" -ForegroundColor White
    Write-Host ""
    Write-Host "  IMPORTANT:" -ForegroundColor Red
    Write-Host "  - This will allow Adobe to connect to the internet again" -ForegroundColor Yellow
    Write-Host "  - Activation checks may resume" -ForegroundColor Yellow
    Write-Host "  - Telemetry and update services may restart" -ForegroundColor Yellow
    Write-Host ""
    Write-Host "================================================================================" -ForegroundColor Yellow
    Write-Host ""
}
...
function Show-DisclaimerAndHelp {
    ...
    Write-Host ""
    Write-Host "================================================================================" -ForegroundColor Cyan
    Write-Host "             ADOBE BLOCKER - DISCLAIMER & HELP DOCUMENTATION                    " -ForegroundColor Cyan
    Write-Host "================================================================================" -ForegroundColor Cyan
    Write-Host ""
    ...
    Write-Host "     - Creates Windows Firewall rules for Adobe executables" -ForegroundColor White
    ...
    Write-Host "     - Scans common Adobe installation directories" -ForegroundColor White
    Write-Host ""
    ...
    Write-Host "     - Adds 40+ Adobe domain entries (activation, licensing, telemetry)" -ForegroundColor White
    ...
    Write-Host "     - Blocks known Adobe IP subnets" -ForegroundColor White
    Write-Host "     - 130.248.0.0/16 (~65,000 IPs)" -ForegroundColor White
    Write-Host "     - 192.150.0.0/16 (~65,000 IPs)" -ForegroundColor White
    Write-Host "     - 193.104.215.0/24 (256 IPs)" -ForegroundColor White
    Write-Host ""
    Write-Host "  4. SERVICE DETECTION:" -ForegroundColor Yellow
    Write-Host "     - Scans for Adobe-related Windows services" -ForegroundColor White
    Write-Host "     - Reports running services (does not stop them)" -ForegroundColor White
    Write-Host ""
    Write-Host "================================================================================" -ForegroundColor Cyan
    Write-Host ""
    Write-Host "OPERATION MODES:" -ForegroundColor Green
    Write-Host "-------------------------------------------------------------------------------" -ForegroundColor Gray
    Write-Host ""
    Write-Host "  [1] BLOCK MODE:" -ForegroundColor Cyan
    Write-Host "      - Applies all blocking measures" -ForegroundColor White
    Write-Host "      - Creates backups before making changes" -ForegroundColor White
    Write-Host "      - Requires user confirmation" -ForegroundColor White
    Write-Host "      - Generates detailed report" -ForegroundColor White
    Write-Host ""
    Write-Host "  [2] DRY RUN MODE:" -ForegroundColor Cyan
    Write-Host "      - Scans and analyzes without making changes" -ForegroundColor White
    Write-Host "      - Perfect for testing and previewing" -ForegroundColor White
    Write-Host "      - Shows what would be blocked" -ForegroundColor White
    Write-Host "      - Generates analysis report" -ForegroundColor White
    Write-Host ""
    Write-Host "  [3] UNBLOCK MODE:" -ForegroundColor Cyan
    Write-Host "      - Removes all firewall rules created by this script" -ForegroundColor White
    Write-Host "      - Restores hosts file from backup" -ForegroundColor White
    Write-Host "      - Restores Adobe internet access" -ForegroundColor White
    Write-Host ""
    Write-Host "  [4] ROLLBACK MODE:" -ForegroundColor Cyan
    Write-Host "      - Restores system to pre-blocking state" -ForegroundColor White
    Write-Host "      - Requires backup files to exist" -ForegroundColor White
    Write-Host "      - Uses most recent backup" -ForegroundColor White
    Write-Host ""
    Write-Host "================================================================================" -ForegroundColor Cyan
    Write-Host ""
    ...
    Write-Host ""
    Write-Host "  Problem: Adobe directory not found" -ForegroundColor Yellow
    Write-Host "  Solution:" -ForegroundColor Cyan
    Write-Host "    - Script will prompt for custom directory" -ForegroundColor White
    Write-Host "    - Enter full path to Adobe installation" -ForegroundColor White
    Write-Host ""
    Write-Host "  Problem: Adobe still connects to internet" -ForegroundColor Yellow
    Write-Host "  Solution:" -ForegroundColor Cyan
    Write-Host "    - Verify Windows Firewall is enabled" -ForegroundColor White
    Write-Host "    - Check rules exist: Get-NetFirewallRule -DisplayName 'AdobeBlocker*'" -ForegroundColor White
    Write-Host "    - Verify hosts file was modified" -ForegroundColor White
    Write-Host "    - Try running script again" -ForegroundColor White
    Write-Host ""
    Write-Host "  Problem: Want to completely reset firewall" -ForegroundColor Yellow
    Write-Host "  Solution:" -ForegroundColor Cyan
    Write-Host "    - Open Command Prompt as Administrator" -ForegroundColor White
    Write-Host "    - Run: netsh advfirewall reset" -ForegroundColor White
    Write-Host "    - WARNING: This removes ALL custom firewall rules!" -ForegroundColor Red
    Write-Host ""
    Write-Host "================================================================================" -ForegroundColor Cyan
    Write-Host ""
    ...
    Write-Host "-------------------------------------------------------------------------------" -ForegroundColor Gray
    Write-Host ""
    Write-Host "  Remove all Adobe blocker rules:" -ForegroundColor Yellow
    Write-Host "    Get-NetFirewallRule -DisplayName 'AdobeBlocker*' | Remove-NetFirewallRule" -ForegroundColor White
    Write-Host ""
    Write-Host "  View current rules:" -ForegroundColor Yellow
    Write-Host "    Get-NetFirewallRule -DisplayName 'AdobeBlocker*' | Select DisplayName, Enabled" -ForegroundColor White
    Write-Host ""
    ...
    Write-Host "    2. Type: SystemPropertiesProtection" -ForegroundColor White
    Write-Host "    3. Click 'Create' button" -ForegroundColor White
    Write-Host "    4. Enter description and wait for completion" -ForegroundColor White
    Write-Host ""
    Write-Host "  To restore system:" -ForegroundColor Yellow
    Write-Host "    1. Settings > System > About > System Protection" -ForegroundColor White
    Write-Host "    2. Click 'System Restore'" -ForegroundColor White
    Write-Host "    3. Select restore point created before running this script" -ForegroundColor White
    Write-Host ""
    Write-Host "================================================================================" -ForegroundColor Cyan
    Write-Host ""
...
function Invoke-UnblockMode {
    ...
    Write-Host "================================================================================" -ForegroundColor Green
    Write-Host ""
    Write-Host "  Adobe internet access has been restored." -ForegroundColor Green
    Write-Host ""
}
...
function Invoke-AdobeDirectoryScan {
    param([string]$Path)
    
    Write-Host ""
    Write-Host "  [INFO] Scanning: $Path" -ForegroundColor Cyan
    
    $files = Get-AdobeFiles -Path $Path
    
    if ($files.Count -eq 0) {
        Write-Host "  [WARNING] No Adobe files found in this directory" -ForegroundColor Yellow
        return 0
    }
    ...
    for ($i = 0; $i -lt $fileArray.Count; $i++) {
        ...
        Write-Progress -Activity "Processing Adobe Files" -Status "$percentage% Complete" -PercentComplete $percentage -CurrentOperation $file.Name
    ...
    Write-Progress -Activity "Processing Adobe Files" -Completed
...
function Invoke-SystemLocationScan {
    Write-Host ""
    ...
    foreach ($location in $locations) {
        if (Test-Path $location) {
            $count = Invoke-AdobeDirectoryScan -Path $location
    ...
    if ($totalProcessed -eq 0) {
        Write-Host ""
        Write-Host "  [WARNING] No Adobe files found in common locations" -ForegroundColor Yellow
        Write-Host "  [INFO] Would you like to specify a custom Adobe directory? (yes/no): " -ForegroundColor Cyan -NoNewline
        $response = Read-Host
        
        if ($response -match '^(yes|y)$') {
            Write-Host "  Enter custom Adobe directory path: " -ForegroundColor Cyan -NoNewline
            $customPath = Read-Host
            
            if (Test-Path $customPath) {
                $count = Invoke-AdobeDirectoryScan -Path $customPath
                $totalProcessed += $count
            }
            else {
...
function Invoke-SmartLocationScan {
    Write-Host ""
    Write-Host "[Step 5] Smart scanning Adobe installation directories..." -ForegroundColor Cyan
    ...
    $totalProcessed = 0
    $uniqueLocations = $locations | Select-Object -Unique
    
    foreach ($path in $uniqueLocations) {
        if (Test-Path $path) {
            $count = Invoke-AdobeDirectoryScan -Path $path
            $totalProcessed += $count
        }
    }
    
    if ($totalProcessed -gt 0) {
        Write-Host "  [OK] Processed $totalProcessed files from smart locations" -ForegroundColor Green
    }
    else {
        Write-Host "  [INFO] No files found in smart locations" -ForegroundColor Cyan
    }
    
    Write-Log "Processed $totalProcessed files from smart locations" -Level INFO
    return $totalProcessed
}

function Block-AdobeDomains {
    Write-Host ""
    Write-Host "[Step 6] Blocking Adobe domains via hosts file..." -ForegroundColor Cyan
    ...
    try {
        ...
        if ($newEntries.Count -gt 0) {
            $newEntries = @("", "# Adobe Blocker Entries - Added $(Get-Date)") + $newEntries
...
function Block-AdobeIPRanges {
    Write-Host ""
    Write-Host "[Step 7] Blocking Adobe IP ranges..." -ForegroundColor Cyan
    
    $ipRanges = @(
        @{ Range = "130.248.0.0/16"; Description = "Adobe Systems Inc. - Primary Range" },
        @{ Range = "192.150.0.0/16"; Description = "Adobe Systems Inc. - Secondary Range" },
        @{ Range = "193.104.215.0/24"; Description = "Adobe Systems EU" }
    )
...
function Get-AdobeServiceReport {
    Write-Host ""
    Write-Host "[Step 8] Detecting Adobe services..." -ForegroundColor Cyan
    
    try {
        $services = Get-Service | Where-Object { $_.DisplayName -like "*Adobe*" }
        
        if ($services) {
            Write-Host "  [INFO] Found $($services.Count) Adobe-related services:" -ForegroundColor Yellow
            ...
            Write-Host "  [INFO] No Adobe services detected" -ForegroundColor Cyan
            Write-Log "No Adobe services found" -Level INFO
        }
...
function New-ExecutionReport {
    ...
    $report = @"
================================================================================
                    ADOBE BLOCKER EXECUTION REPORT
================================================================================
...
try {
    ...
    switch ($mode) {
        "1" {
            ...
            Invoke-SystemLocationScan | Out-Null
            Invoke-SmartLocationScan | Out-Null
            Block-AdobeDomains | Out-Null
            Block-AdobeIPRanges | Out-Null
            Get-AdobeServiceReport | Out-Null
            New-ExecutionReport
            ...
            Write-Host "================================================================================" -ForegroundColor Green
            Write-Host ""
            Write-Host "  Adobe internet access has been blocked successfully!" -ForegroundColor Green
            Write-Host ""
        }
        "2" {
